    ...
    <div>
        <div className='text-4xl font-semibold text-center my-10'>
            ...
            <div className='flex flex-col lg:flex-row items-center justify-center mt-8 lg:mt-0'>
                <img src={Image1} className='object-contain  lg:-mr-32' alt=''/>
                <img src={Image2} className='object-contain lg:-mb-10 lg:-mt-0 -mt-12' alt=''/>
                <img src={Image3} className='object-contain  lg:-ml-36 lg:-mt-5 -mt-16' alt=''/>
            </div>
        </div>
