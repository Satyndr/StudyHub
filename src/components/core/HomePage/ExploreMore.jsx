...
const ExploreMore = () => {
    ...
    return(
        <div>
            ...
            <div className='lg:relative gap-10 justify-center lg:gap-0 flex lg:justify-between flex-wrap w-[80%] lg:bottom-[0] lg:left-[50%] lg:translate-x-[-50%] lg:translate-y-[50%] text-black lg:mb-0 mb-7 lg:px-0 px-3'>
                {
